...
case "${1}" in
    "on")
        notify-send -a "Informações sobre o modo de redimensionamento" -r 2222 -i "$HOME/.icons/system/settings.png" -u critical -t 0 "Você ativou o modo de redimensionamento"
    ;;
    "off")
